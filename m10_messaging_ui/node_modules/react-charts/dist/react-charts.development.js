(function (global, factory) {
  ...
  var Voronoi = /*#__PURE__*/function () {
    ...
    _createClass(Voronoi, [{
      ...
      value: /*#__PURE__*/regeneratorRuntime.mark(function neighbors(i) {
        var ci, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, j, cj, ai, li, aj, lj;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 5;
                _iterator = this.delaunay.neighbors(i)[Symbol.iterator]();
        ...
        }, neighbors, this, [[5, 30, 34, 42], [35,, 37, 41]]);
      })
    }, {
      key: "_cell",
  ...
  function flatIterable(points, fx, fy, that) {
    var i, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, p;
  ...
  function band() {
    ...
    scale.range = function (_) {
      ...
      return arguments.length ? ((_ref3 = _, _ref4 = _slicedToArray(_ref3, 2), r0 = _ref4[0], r1 = _ref4[1], _ref3), r0 = +r0, r1 = +r1, rescale()) : [r0, r1];
    };

    scale.rangeRound = function (_) {
      var _ref5, _ref6;

      return (_ref5 = _, _ref6 = _slicedToArray(_ref5, 2), r0 = _ref6[0], r1 = _ref6[1], _ref5), r0 = +r0, r1 = +r1, round = true, rescale();
    };
  ...
  function Voronoi$1() {
    ...
    return React.useMemo(function () {
      ...
      var voronoi = delaunay.voronoi(extent.flat());
      polygons = _toConsumableArray(voronoi.cellPolygons());
    ...
    }, [gridHeight, gridWidth, height, needsVoronoi, onHover, primaryAxes.length, secondaryAxes.length, showVoronoi, stackData, width]);
  }
  ...
  function Axis(props) {
    return React.createElement(AxisLinear, props);
  }
  ...
  function Line$1(_ref) {
    ...
    return React.createElement("g", null, React.createElement(Path$2, pathProps), showPoints && series.datums.map(function (datum, i) {
  ...
  function Area(_ref) {
    ...
    var areaPathProps = {
      d: areaPath,
      style: _objectSpread2({}, defaultAreaStyle, {}, style, {}, style.area)
    };
    var linePathProps = {
      d: linePath,
      style: _objectSpread2({}, defaultLineStyle, {}, style, {}, style.line, {
        fill: 'none'
      })
    };
    return React.createElement("g", null, React.createElement(Path$2, areaPathProps), React.createElement(Path$2, linePathProps), showOrphans && series.datums.map(function (datum, index, all) {
      ...
      return React.createElement(Point$2, {
        key: i,
        datum: datum,
        style: style
      });
  ...
  var OrphanLine = function OrphanLine(_ref4) {
    ...
    var lineProps = {
      ...
      style: _objectSpread2({}, defaultLineStyle, {}, style, {}, style.line, {}, dataStyle, {}, dataStyle.line)
    };
  ...
  function Point$2(_ref5) {
    ...
    var circleProps = {
      x: datum ? datum.x : undefined,
      y: datum ? datum.y : undefined,
      style: _objectSpread2({}, circleDefaultStyle$2, {}, style, {}, style.circle, {}, dataStyle, {}, dataStyle.circle),
      onMouseEnter: React.useCallback(function (e) {
        return setChartState(function (state) {
          return _objectSpread2({}, state, {
            element: datum
  ...
  var _scales;
  var scales = (_scales = {}, _defineProperty(_scales, axisTypeLinear, linear$1), _defineProperty(_scales, axisTypeLog, log), _defineProperty(_scales, axisTypeTime, time), _defineProperty(_scales, axisTypeUtc, utcTime), _defineProperty(_scales, axisTypeOrdinal, band), _scales);
  ...
  var defaultColors = ['#ff3465', '#ff5454', '#ff7b3e', '#FAA43A', '#ffd000', '#C8DE2B', '#97d114', '#34ce70', '#3cada4', '#14b4d3', '#048cd4', '#3447f1', '#734fe9', '#cd82ad', '#c63b89'];
  ...
  function Chart(_ref) {
    var data = _ref.data,
        ...
        getPrimaryAxisID = _ref.getPrimaryAxisID,
        getSecondaryAxisID = _ref.getSecondaryAxisID,
        getSeriesStyleOriginal = _ref.getSeriesStyle,
    ...
    }, [brush, pointer, pointer.released, pointer.sourceX, pointer.x, previousDragging, primaryAxes]);
    ...
    }, [getSeriesStyleOriginal]); // Decorate the chartState with computed values (or ones we just
