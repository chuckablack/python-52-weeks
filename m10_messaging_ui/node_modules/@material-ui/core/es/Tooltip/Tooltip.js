...
const Tooltip = React.forwardRef(function Tooltip(props, ref) {
  ...
  const childrenProps = _extends(_extends(_extends({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, React.cloneElement(children, childrenProps), /*#__PURE__*/React.createElement(PopperComponent, _extends({
