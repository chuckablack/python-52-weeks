...
def main():
    ...
    print(f"---> Completed pinging {len(hosts)} hosts NOT using threadpool, time:", ping_without_threadpool_time)

    print("\nResults:")
    print(f"     Using threadpool:     {ping_with_threadpool_time}")
    print(f"     Not using threadpool: {ping_without_threadpool_time}\n")
